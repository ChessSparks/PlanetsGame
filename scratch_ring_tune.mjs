...
const BUILDING_MAX_FOOTPRINT = 8;
...
const BUILDING_RINGS = [
  ...
  { arcDistance: 36, count: 6, asset: 'sci' },
  { arcDistance: 55, count: 2, asset: 'milk' },
  { arcDistance: 60, count: 6, asset: 'sci4' },
  { arcDistance: 80, count: 4, asset: 'aband' },
  { arcDistance: 95, count: 2, asset: 'cyber1' },
  { arcDistance: 100, count: 2, asset: 'planet' },
];
